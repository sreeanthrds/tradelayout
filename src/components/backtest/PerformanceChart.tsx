...
export function PerformanceChart({ chartType }: PerformanceChartProps) {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-80 w-full bg-gray-50 rounded animate-pulse">
  ...
  if (error || noDataError) {
    return (
      <div className="text-red-500 p-4 bg-red-50 rounded h-80 flex items-center justify-center">
